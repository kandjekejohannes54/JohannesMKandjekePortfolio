...
# --- THEME DESIGN SYSTEM (Arctic Ocean Blue (Light)) ---
BG = '#F0F4F8'
SURFACE = '#FFFFFF'
TEXT = '#102A43'
MUTED = '#627D98'
...
def main(page: ft.Page):
    page.title = "Johannes M Kandjeke - SiteSpy Portfolio"
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=ft.Column([
                    ...
                    ft.Text("Johannes M Kandjeke", size=34, weight=ft.FontWeight.W_900, color=TEXT),
                    ft.Row([
                        ft.Icon(ft.Icons.WORK_OUTLINE, size=15, color=MUTED),
                        ft.Text("Role: Frontend (Agriculture Department)", color=MUTED, size=14),
                        ft.Container(width=10),
                        ft.Icon(ft.Icons.EMAIL_OUTLINED, size=15, color=MUTED),
                        ft.Text("Kandjekejohannes54@gmail.com", color=MUTED, size=14, selectable=True),
                    ], wrap=True),
                    ft.Row([
                        ft.Icon(ft.Icons.LINK, size=15, color=ACCENT),
                        ft.Text("GitHub Profile: github.com/kandjekejohannes54", color=ACCENT, size=14, selectable=True)
                    ], wrap=True),
                ], spacing=12)
            ),
            ...
            ft.Container(
                ...
                content=ft.Column([
                    profile_img,
                    ft.Container(
                        content=ft.Text("STATUS: MATCHED", size=11, color=BG, weight=ft.FontWeight.BOLD),
                        bgcolor=SUCCESS,
    ...
    # Files list
    files_list = []
    for f in ['docs/Testing_Checklist.md', 'docs/User_Manual.md', 'src/theme/spacing.js', 'src/theme/typography.js']:
        files_list.append(
            ft.Container(
                padding=10,
                border_radius=6,
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=tile_card("My Project Focus", [
                    ft.Text("Responsive testing documentation and typography/spacing checks.", size=14, color=TEXT),
            ...
            ft.Container(
                ...
                content=tile_card("Submission Information", [
                    ...
                    ft.Text('git config user.name "Johannes M Kandjeke"\ngit config user.email "Kandjekejohannes54@gmail.com"', size=11, font_family="Consolas", color=TEXT, selectable=True),
                    ft.Divider(color=BORDER),
    ...
    footer = ft.Container(
        ...
        content=ft.Column([
            ft.Text("Johannes M Kandjeke | SiteSpy Portfolio Showcase", color=TEXT, size=14, weight=ft.FontWeight.BOLD),
